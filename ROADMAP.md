...
A broader module set across all six layers (18 CTX techniques implemented across every tactic,
19 runnable modules), the complete range (done, incl. the networked MCP variant), replayable
