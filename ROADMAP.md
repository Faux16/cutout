...
A broader module set across all six layers (17 CTX techniques implemented across every tactic,
18 runnable modules), the complete range (done, incl. the networked MCP variant), replayable
