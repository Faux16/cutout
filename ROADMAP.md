...
A broader module set across all six layers (19 CTX techniques implemented across every tactic,
20 runnable modules), the complete range (done, incl. the networked MCP variant), replayable
