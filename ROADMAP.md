...
A broader module set across all six layers (20 CTX techniques implemented across every tactic,
21 runnable modules), the complete range (done, incl. the networked MCP variant), replayable
